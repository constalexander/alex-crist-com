...
export function TechStack() {
  return (
    <div className="h-0 relative -top-[100px] z-50 mx-auto max-w-[90%] sm:max-w-[600px] p-0 m-0">
      <div className="h-fit bg-stone-900 rounded-xl shadow-xl border border-stone-700 py-8">
        <div className="text-2xl text-stone-400 text-center mb-6">
          Tech stack
        </div>
