...
export function Header(props: HeaderProps) {
  ...
  return (
    <section
      id="Header"
      className="w-full h-full p-4 z-40 bg-stone-950 border-b border-stone-600"
    >
      <div className="header-content flex justify-between items-center mx-auto bg-stone-900 sm:w-[600px]">
        <img
